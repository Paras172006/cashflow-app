    ...
    <div className="fixed z-50 bg-slate-900 p-6 top-1/2 left-1/2 -translate-1/2">
      ...
      <div className="mb-6">
        ...
        <input
          ...
          className="w-full px-3 py-2 bg-slate-800 border border-emerald-900/30 rounded-sm text-gray-100 placeholder:text-gray-500 focus:outline-none focus:border-emerald-500 disabled:opacity-50"
        />
      </div>
      ...
      <div className="flex gap-3 justify-end">
        <button
          onClick={handleClose}
          disabled={isDeleting}
          className="px-4 py-2 border border-emerald-700 text-emerald-300 rounded-sm hover:bg-emerald-900 transition-colors disabled:opacity-50"
        >
          Cancel
        </button>
        <button
