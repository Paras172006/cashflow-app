...
export default function AvatarUpload() {
  ...
  return (
    <div className=" border border-emerald-950 rounded-sm p-6">
      ...
      <div className="flex flex-col items-center gap-6 lg:flex-row lg">
        <div className="">
          {previewUrl || avatarUrl ? (
            <img
              ...
              alt="Avatar"
              className="size-32 rounded-full object-cover border-2 border-emerald-500"
            />
          ) : (
            <div className="size-32 rounded-full bg-emerald-900/30 border-2 border-emerald-500 flex items-center justify-center">
              {user ? (
        ...
        <div className="flex flex-col gap-3 flex-1 items-center">
          <div className="flex gap-3">
            <label className="px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white rounded-sm cursor-pointer flex items-center gap-2 transition-colors">
