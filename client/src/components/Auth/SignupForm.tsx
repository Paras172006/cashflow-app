      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-6">
        ...
        <div className="flex flex-col gap-2">
          ...
          <input
            ...
            value={name}
            className="px-4 py-3 bg-slate-800 border border-slate-700 rounded-sm text-gray-100 focus:outline-none focus:border-emerald-500 transition-colors"
          />
        </div>
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="relative">
            <input
              ...
              value={password}
              className="w-full px-4 py-3 bg-slate-800 border border-slate-700 rounded-sm text-gray-100 focus:outline-none focus:border-emerald-500 transition-colors"
            />
            <button
              type="button"
        ...
        <button
          type="submit"
          disabled={isLoading}
          className="px-6 py-3 bg-emerald-800 text-gray-100 rounded-sm hover:bg-emerald-700 transition-colors cursor-pointer border border-emerald-700 font-medium"
        >
