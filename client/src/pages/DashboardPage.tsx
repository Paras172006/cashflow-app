...
export default function DashboardPage() {
      ...
      <main className="bg-slate-950 p-4 sm:px-8 sm:py-12">
        <div className="flex flex-col items-center justify-center min-h-[60vh] gap-6">
          ...
          <button
            ...
            className="flex items-center gap-2 px-6 py-3 bg-emerald-950 text-gray-100 rounded-sm hover:bg-emerald-800 transition font-medium"
          >
  ...
  return (
    <main className="bg-slate-950 px-4 py-8 sm:px-8 sm:py-12">
      <div className="border-b border-emerald-950 pb-4 mb-8 flex flex-col gap-8 justify-start sm:gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 px-6 py-3 bg-emerald-950 text-gray-100 rounded-sm hover:bg-emerald-800 transition font-medium"
        >
          <Plus className="size-5" />
          Add Expense
        </button>
      ...
      <div className="flex flex-col gap-4 p-6 mt-8 border border-emerald-950 rounded-sm">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="text-sm text-emerald-400 hover:text-emerald-300 transition-colors font-medium flex gap-2"
          >
