        ...
        <>
          ...
          {mode === "view" ? (
            <div className="grid gap-4 grid-cols-4 sm:grid-cols-[150px_150px_150px_150px] md:col-start-1 md:col-end-2 md:grid-cols-3">
              ...
              <button
                onClick={handleEdit}
                className="px-6 py-3 bg-emerald-950 text-gray-100 rounded-sm hover:bg-emerald-800 transition-colors cursor-pointer  font-medium row-start-2 col-span-2 sm:col-span-1"
              >
                Edit Profile
              </button>
            </div>
