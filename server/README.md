# CashFlow — Backend (Server)

A REST API built with Express 5, TypeScript, MongoDB, and JWT authentication. The server handles all business logic, database operations, file uploads, and serves analytics data to the CashFlow frontend client.
